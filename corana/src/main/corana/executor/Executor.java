...
public class Executor {
    ...
    public static Map.Entry<Environment, List<String>> customExecute(Variation var, String inpFile, long startPC, long endPC, Environment initEnv) {
            ...
            if ("b".equals(opcode) || "bl".equals(opcode) || "bx".equals(opcode) || "blx".equals((opcode))) {
                ...
                for (String p : arrParams) {
                    ...
                    if (c.equals('p')) {
                        ...
                        if (Arithmetic.hexToInt(pcValue.getSym()) > 20000) {
                            jumpFrom = nLabel;
                ...
                if (p0.equals('p')) {
                    ...
                    //if (nodeLabelToIndex.containsKey(String.valueOf(Arithmetic.hexToInt(pcValue.getSym())))) {
                        jumpFrom = nLabel;
                        ...
                        boolean isGlibC = !funcname.equals("") && APIlist.contains(funcname);
