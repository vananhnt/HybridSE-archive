...
public class M7 extends Emulator {

    public M7(Environment env) {
        super(env);
    }
    ...
    public void vrinta(Character xd, Character xm) {
        arithmeticMode = ArithmeticMode.FLOATING_POINT;
        BitVec result = val(xm);
        result = round(result, RoundType.NEAREST_TIE);
        write(xd, result);
    ...
    public void vrintm(Character xd, Character xm) {
        arithmeticMode = ArithmeticMode.FLOATING_POINT;
        BitVec result = val(xm);
        result = round(result, RoundType.TOWARDS_MINUS_INF);
        write(xd, result);
    ...
    public void vrintn(Character xd, Character xm) {
        arithmeticMode = ArithmeticMode.FLOATING_POINT;
        BitVec result = val(xm);
        result = round(result, RoundType.NEAREST_EVEN);
        write(xd, result);
    ...
    public void vrintp(Character xd, Character xm) {
        arithmeticMode = ArithmeticMode.FLOATING_POINT;
        BitVec result = val(xm);
        result = round(result, RoundType.TOWARDS_PLUS_INF);
        write(xd, result);
    ...
    public void vrintz(Character xd, Character xm) {
        arithmeticMode = ArithmeticMode.FLOATING_POINT;
        BitVec result = val(xm);
        result = round(result, RoundType.TOWARDS_ZERO);
        write(xd, result);
    }
